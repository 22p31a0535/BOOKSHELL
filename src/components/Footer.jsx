            ...
            <div className={styles.grid}>
                <div className={styles.logoBlock}>
                    ...
                    <p className={styles.aboutText}>
                        Your gateway to literact adventures.Discover,explore,and immerse yourself in the world of books.
                    </p>
                ...
                <div className={styles.newsletterBlock}>
                    ...
                    <p className={styles.newsletterText}>
                        Suscribe to our newsletter for the latest releases and exclussive offers.        
                    </p>
                ...
                <div className={styles.contactBlock}>
                    ...
                    <div className={styles.contactList}>
                        <div className={styles.contactItem}>
                           ...
                           <span>123 Literacy Lane,BookVille,BK 12345</span>
                        </div>
