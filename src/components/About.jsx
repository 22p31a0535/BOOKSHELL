...
import { Clock, Facebook, Icon, Instagram, MapPin, Twitter } from 'lucide-react'
    ...
    return (
        <div className={aboutStyles.container}>
                    ...
                    <div className={aboutStyles.headingWrapper}>
                        <div className='relative inline-block'>
                            <h1 className={aboutStyles.heading}>
                                Crafting Literacy <br /> Futures
                            </h1>
                            <div className={aboutStyles.underline} />
                        </div>
                        <p className={aboutStyles.subText}>
                            Pioneering the next chapter in global storytelling.We bridge imagination with innovation through curated literacy experience.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                        <div className={aboutStyles.aboutImageWrapper}>
                            ...
                            <div className={aboutStyles.aboutCaption}>
                                ...
                                <p className={aboutStyles.aboutSubtitle}>Pioneering Digital Literacy</p>
                            </div>
                        </div>
            ...
            <section className={aboutStyles.teamSection}>
                <div className={aboutStyles.innerContainer}>
                    <div className='text-center mb-20'>
                        <h2 className={aboutStyles.sectionTitle}>Meet your Literacy Guides</h2>
            ...
            <section className={aboutStyles.branchSection}>
                <div className={aboutStyles.innerContainer}>
                    <div className='text-center mb-20'>
                        <h2 className={aboutStyles.sectionTitle}>Our Literacy Sanctuaries</h2>
                        <div className={aboutStyles.sectionUnderline}/>
                    </div>
