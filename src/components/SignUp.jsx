    ...
    <div className={Signup.container}>
        ...
        <div className={Signup.card}>
            ...
            <div className=' text-center mb-8'>
                ...
                <p className={Signup.subtext}>Join out community of book lovers</p>
            </div>
            <form onSubmit={handleSubmit} className={Signup.form}>
                <div>
                    ...
                    <div className={Signup.inputWrapper}>
                        ...
                        <input type="text" name='username' placeholder='Enter Username' className={Signup.input} value={formData.username}
                 ...
                 <div>
                    ...
                    <div className={Signup.inputWrapper}>
                        ...
                        <input type="email" name='email' placeholder='email@example.com' className={Signup.input} value={formData.email}
                 ...
                 <div>
                    ...
                    <div className={Signup.inputWrapper}>
                        ...
                        <input type={showPassword ? 'text' : 'password'} name='password' placeholder="••••••••" className={Signup.passwordInput} value={formData.password}
