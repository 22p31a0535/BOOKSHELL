                    ...
                    <div className={styles.contactInfoCardStyle}>
                        ...
                        <div className=' space-y-6'>
                            ...
                            <div className={styles.contactItemStyle}>
                                ...
                                <div>
                                    <h3 className='font-medium text-gray-800 mb-1'></h3>Email
                        ...
                        <form onSubmit={handleSubmit} className=' space-y-6'>
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                                ...
                                <div className=' space-y-2'>
                                    <label className={styles.labelStyle}> Phone <span className='text-gray-500'>(optional)</span>
                                    </label>
                                    <div className={styles.inputWrapperStyle}>
                                ...
                                <div className=' space-y-2'>
                                    <label className={styles.labelStyle}> Subject<span className='text-gray-500'>(optional)</span>
                                    </label>
                                        <input name='subject'value={formData.subject} onChange={handleChange} className={styles.inputStyle}/>
                                </div>
                            </div>

                            <div className=' space-y-2'>
                                    <label className={styles.labelStyle}> Message <span className='text-red-500'></span>
                                    </label>
                                    <div className={styles.inputWrapperStyle}>
                                        <MessageSquare className=' absolute left-3 top-3 text-gray-400 h-5 w-5'/>
                                        <textarea name='message' rows='4' value={formData.message} onChange={handleChange} className={styles.textareaStyle}/>{errors.message && <p className={styles.errorStyle}>{errors.message}</p>}
                                    </div>
                                </div>
