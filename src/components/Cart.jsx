...
import { useCart } from '../CarContext/CartContext'
...
const Cart = () => {
    ...
    //  INCREASING AND DECREASING AND REMOVE
                                            ...
                                            <div className={styles.cartItemTop}>
                                             ...
                                             <div className={styles.quantityPriceWrapper}>
                                                <div className={styles.quantityControls}>
                                                    ...
                                                    <span className={styles.pricePerItem}>₹{(item.price.toFixed(2))} each
                                                    </span> 
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className={styles.summaryCard}>
                            ...
                            <div className={styles.summaryBreakdown}>
                                <div className={styles.summaryRow}>
                                    <span className={styles.summaryLabel}>Subtotal({cart.items.length} items)
                                    </span>
                                ...
                                <Link to='/books' className={styles.continueBtn}>
                                 <BookOpen className={styles.continueIcon}/>Continue Shopping
                              </Link>
                            </div>
                    </div>
                )}
